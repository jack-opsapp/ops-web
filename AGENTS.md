...
Supplements the root `OPS LTD./AGENTS.md`. Read both.
...
Full reference: `ops-software-bible/05_DESIGN_SYSTEM.md` Section 15. Use this scale for all new z-index values.
