-- Correct the guarded staff false-lead repair to compare the live text
-- notifications.company_id tenant key with the UUID repair scope. The
-- function signature, fail-closed row inventory, privileges, and all write
