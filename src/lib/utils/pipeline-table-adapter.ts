...
export function mapOpportunityToTableRow(
  ...
  return {
    ...
    lastInboundAt: toIso(opp.lastInboundAt),
    lastOutboundAt: toIso(opp.lastOutboundAt),
    lastMessageDirection: opp.lastMessageDirection,
    handledAt: toIso(opp.handledAt),
    operatorActionRequiredAt: toIso(opp.operatorActionRequiredAt),
