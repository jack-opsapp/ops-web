...
export const JOURNAL_IMAGE_STYLE = [
  ...
  "Default to distance and scale. Shoot from far away with a wide or long lens so the subject is small inside a much larger",
  "landscape, street, valley, shoreline or sky, and negative space takes half the frame or more; the place carries the picture.",
  "An interesting, impressive photograph with a sense of scale, the kind that makes a person stop. Close and medium shots",
  "are the exception, only when one detail must be read.",
