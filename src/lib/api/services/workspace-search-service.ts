 ...
 * company filter of its own. A PostgREST error is rethrown with its message
 * intact — a swallowed error here would render as "no matches" and hide a
 * permission or deployment fault.
 */
