...
export const BubbleProductFields = {
  id: "_id",
  company: "company",
  name: "name",
  description: "description",
  ...
  sku: "sku",
  active: "active",
  externalQboId: "externalQboId",
  externalSageId: "externalSageId",
  deletedAt: "deletedAt",
} as const;

// ─── Estimate Field Names ─────────────────────────────────────────────────────

export const BubbleEstimateFields = {
  id: "_id",
  company: "company",
  project: "project",
  client: "client",
...
export const BubbleInvoiceFields = {
  id: "_id",
  company: "company",
  project: "project",
  client: "client",
...
// ─── LineItem Field Names ─────────────────────────────────────────────────────

export const BubbleLineItemFields = {
  id: "_id",
...
export const BubblePaymentFields = {
  id: "_id",
  invoice: "invoice",
  company: "company",
  amount: "amount",
...
// ─── AccountingConnection Field Names ─────────────────────────────────────────

export const BubbleAccountingConnectionFields = {
  id: "_id",
  company: "company",
  provider: "provider",
  ...
  webhookVerifierToken: "webhookVerifierToken",
} as const;

// ─── Estimate Status Values ──────────────────────────────────────────────────

export const BubbleEstimateStatus = {
  draft: "Draft",
  sent: "Sent",
  accepted: "Accepted",
  rejected: "Rejected",
...
export const BubbleInvoiceStatus = {
  draft: "Draft",
  sent: "Sent",
  partial: "Partial",
  paid: "Paid",
...
// ─── Financial Entity Type Names ─────────────────────────────────────────────

export const BubbleFinancialTypes = {
  product: "Product",
  estimate: "Estimate",
  invoice: "Invoice",
  lineItem: "LineItem",
