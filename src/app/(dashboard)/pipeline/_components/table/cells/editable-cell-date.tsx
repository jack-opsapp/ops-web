  ...
  if (isEditing) {
    return (
      <input
        ...
        className={cn(
          "h-[28px] w-full min-w-0 rounded-[5px] border border-border bg-surface-input px-2 font-mono tabular-nums text-text outline-none focus-visible:ring-1 focus-visible:ring-ops-accent",
