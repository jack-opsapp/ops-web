...
export const PipelineFocusedColumn = memo(function PipelineFocusedColumn({
  ...
  return (
    <section className="relative h-full w-full min-w-0">
      <header className="glass-dense absolute left-0 right-0 top-[128px] z-[2] isolate min-h-[52px] overflow-hidden px-3 py-2 focus-within:outline focus-within:outline-2 focus-within:outline-offset-2 focus-within:outline-ops-accent">
        <span
          aria-hidden="true"
