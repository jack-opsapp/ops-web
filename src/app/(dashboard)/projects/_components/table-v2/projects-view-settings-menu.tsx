...
export function ProjectsViewSettingsMenu({
  activeView,
  actions,
  onViewRenamed,
  onViewDuplicated,
  ...
  onViewRenamed: (view: ProjectTableViewDefinition) => void;
  onViewDuplicated: (view: ProjectTableViewDefinition) => void;
  onViewArchived: (viewId: string) => void;
  onViewReset: (view: ProjectTableViewDefinition) => void;
  ...
  const menuId = useMemo(() => `project-view-menu-${inputId}`, [inputId]);
