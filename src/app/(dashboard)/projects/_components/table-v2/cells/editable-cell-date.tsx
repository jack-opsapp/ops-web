  ...
  if (isEditing) {
    return (
      <input
        ...
        className={cn(
          "h-[28px] w-full min-w-0 rounded border border-border bg-surface-input px-2 font-mono text-text outline-none focus-visible:ring-1 focus-visible:ring-ops-accent",
