      ...
      <div className="relative flex min-w-0 flex-1 flex-col gap-2 p-2.5">
        ...
        <div className="flex items-center gap-1.5">
          <button
            type="button"
            onClick={onUndo}
            className="rounded border border-border px-2 py-1 font-cakemono text-[14px] font-light uppercase text-text-2 transition-colors hover:bg-surface-hover hover:text-text focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ops-accent"
          >
            {t("table.undo.action")}
          </button>
          <button
            type="button"
            onClick={onDismiss}
            className="rounded px-2 py-1 font-cakemono text-[14px] font-light uppercase text-text-mute transition-colors hover:bg-surface-hover hover:text-text-2 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ops-accent"
          >
