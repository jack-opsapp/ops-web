  ...
  if (editing) {
    return (
      <textarea
        ...
        rows={3}
        className="w-full px-1 py-0.5 bg-[rgba(255,255,255,0.06)] border border-[rgba(111, 148, 176,0.3)] rounded-sm font-mohave text-body-sm text-text focus:outline-none resize-none"
      />
    );
  }
