...
export const SPREADSHEET_COLUMNS: SpreadsheetColumnDef[] = [
  ...
  { id: "tasks",         header: "tasks",         width: "100px",   sortable: true,  editable: false,      defaultVisible: false },
  { id: "duration",      header: "duration",      width: "80px",    sortable: true,  editable: "number",   defaultVisible: false, mono: true },
  { id: "team",          header: "team",          width: "100px",   sortable: false, editable: false,      defaultVisible: false },
  { id: "images",        header: "images",        width: "100px",   sortable: false, editable: false,      defaultVisible: false },
  ...
  { id: "notes",         header: "notes",         width: "200px",   sortable: false, editable: false,      defaultVisible: false },
