  ...
  if (editing) {
    return (
      <input
        ...
        className="w-full px-1 py-0.5 bg-[rgba(255,255,255,0.06)] border border-[rgba(111, 148, 176,0.3)] rounded-sm font-mono text-data-sm text-text focus:outline-none"
      />
    );
  }
