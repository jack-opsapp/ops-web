      ...
      >
        ...
        <div className="flex items-center justify-end gap-2">
          ...
          <button
            ...
            className="px-4 py-2 rounded-panel font-mohave text-body-sm text-text bg-[rgba(111, 148, 176,0.2)] hover:bg-[rgba(111, 148, 176,0.3)] border border-[rgba(111, 148, 176,0.3)] transition-colors duration-150"
          >
