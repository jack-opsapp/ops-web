...
export function ProjectCanvas({
  ...
  const viewportX = useProjectCanvasStore((s) => s.viewportX);
  const viewportY = useProjectCanvasStore((s) => s.viewportY);
  const zoom = useProjectCanvasStore((s) => s.zoom);
  const setViewport = useProjectCanvasStore((s) => s.setViewport);
  const zoomBy = useProjectCanvasStore((s) => s.zoomBy);
  const setCanvasDimensions = useProjectCanvasStore((s) => s.setCanvasDimensions);
  const hideContextMenu = useProjectCanvasStore((s) => s.hideContextMenu);
  const clearSelection = useProjectCanvasStore((s) => s.clearSelection);
  const startMarquee = useProjectCanvasStore((s) => s.startMarquee);
  const updateMarquee = useProjectCanvasStore((s) => s.updateMarquee);
  const endMarquee = useProjectCanvasStore((s) => s.endMarquee);
  ...
  const screenToCanvas = useCallback(
    (clientX: number, clientY: number) => {
      ...
      const state = useProjectCanvasStore.getState();
      return {
