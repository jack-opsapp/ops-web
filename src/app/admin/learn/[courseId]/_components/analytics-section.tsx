import type { LearnCourseAnalytics } from "@/lib/admin/types";
        ...
        <div>
          ...
          <div className="border border-white/[0.08] rounded-lg overflow-hidden">
            ...
            <div className="grid grid-cols-[1fr_80px_100px_100px_100px] gap-4 px-6 h-10 items-center bg-white/[0.02] border-b border-white/[0.08]">
              <p className="font-mohave text-[12px] uppercase tracking-widest text-[#6B6B6B]">Assessment</p>
              <p className="font-mohave text-[12px] uppercase tracking-widest text-[#6B6B6B]">Type</p>
              <p className="font-mohave text-[12px] uppercase tracking-widest text-[#6B6B6B] text-right">Submissions</p>
              <p className="font-mohave text-[12px] uppercase tracking-widest text-[#6B6B6B] text-right">Pass Rate</p>
              <p className="font-mohave text-[12px] uppercase tracking-widest text-[#6B6B6B] text-right">Avg Score</p>
            </div>
            {/* Rows */}
