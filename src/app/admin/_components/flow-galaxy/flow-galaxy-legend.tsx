        ...
        {!collapsed && (
          <div className="px-3 pb-2 space-y-1.5">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-kosugi text-micro text-[#A0A0A0]">Healthy (&lt;25% drop)</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-[6px] h-[6px] rounded-full" style={{ background: '#C4A868' }} />
              <span className="font-kosugi text-micro text-[#A0A0A0]">Moderate (25-55%)</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-[6px] h-[6px] rounded-full" style={{ background: 'rgb(147,65,55)' }} />
              <span className="font-kosugi text-micro text-[#A0A0A0]">Critical (&gt;55% drop)</span>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-kosugi text-micro text-[#A0A0A0]">Size = traffic</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-[6px] h-[6px] rounded-full bg-ops-accent/30 ring-1 ring-[#597794]/20" />
              <span className="font-kosugi text-micro text-[#A0A0A0]">Glow = engagement</span>
            </div>

            <div className="border-t border-white/[0.05] my-1" />

            {/* Interaction hints */}
            <span className="font-kosugi text-micro text-[#6B6B6B] block">Scroll to zoom / Drag to pan</span>
            <span className="font-kosugi text-micro text-[#6B6B6B] block">Click node for details</span>
            <span className="font-kosugi text-micro text-[#6B6B6B] block">Right-click to trace flow</span>
          </div>
        )}
      </div>
    </div>
