    ...
    <header className="flex items-end justify-between border-b border-white/[0.08] px-8 py-6">
      ...
      <div className="flex items-center gap-4">
        <Link
          ...
          className="rounded-[5px] border border-white/[0.12] px-3 py-2 font-cakemono text-[12px] font-light uppercase text-[#EDEDED] transition-colors duration-150 ease-[cubic-bezier(0.22,1,0.36,1)] hover:bg-white/[0.05]"
        >
          ANALYTICS
        </Link>
