            ...
            <li key={row.status} className="font-mono text-[11px] uppercase tracking-[0.12em]">
              ...
              <div className="mt-1 h-[2px] w-full overflow-hidden rounded-bar bg-white/[0.06]">
                <div
                  ...
                  className="h-full bg-fill-neutral transition-all duration-300 ease-smooth"
                />
              </div>
            </li>
          );
          ...
          {rows.map((row) => (
            <li key={row.id}>
              <Link
                ...
                className="group flex items-center justify-between gap-3 text-[12px] text-text transition-colors duration-150 ease-smooth hover:text-text"
              >
