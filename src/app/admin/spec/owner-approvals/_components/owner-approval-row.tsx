      ...
      <div className="flex flex-col items-end gap-2">
        <form action={resendAction}>
          ...
          <button
            ...
            className={`inline-flex items-center gap-2 rounded-[5px] border border-ops-accent px-4 py-[6px] font-mono text-[11px] uppercase tracking-[0.12em] text-ops-accent transition-colors duration-150 ease-[cubic-bezier(0.22,1,0.36,1)] hover:bg-ops-accent hover:text-black ${resendPending ? "opacity-50" : ""}`}
          >
        ...
        {!confirmingCancel ? (
          <button
            ...
            disabled={resendPending || cancelPending}
            className="inline-flex items-center gap-2 rounded-[5px] border border-white/[0.10] px-4 py-[6px] font-mono text-[11px] uppercase tracking-[0.12em] text-text-3 transition-colors duration-150 ease-[cubic-bezier(0.22,1,0.36,1)] hover:border-rose hover:text-rose"
          >
            CANCEL REQUEST
          </button>
        ) : (
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                type="submit"
                disabled={cancelPending}
                className={`inline-flex items-center gap-2 rounded-[5px] border border-rose px-4 py-[6px] font-mono text-[11px] uppercase tracking-[0.12em] text-rose transition-colors duration-150 ease-[cubic-bezier(0.22,1,0.36,1)] hover:bg-rose hover:text-black ${cancelPending ? "opacity-50" : ""}`}
              >
