    ...
    <div>
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <select
          ...
          className="bg-white/[0.04] border border-white/[0.08] rounded-sm px-3 py-2 font-mohave text-[13px] text-[#EDEDED] focus:border-[#6F94B0] focus:outline-none"
        >
      ...
      {/* Bulk action bar */}
      {selected.size > 0 && (
        <div className="flex items-center gap-3 mb-3 px-4 py-2 border border-[#6F94B0]/30 rounded-sm bg-ops-accent/5">
          <span className="font-mohave text-[13px] text-[#EDEDED]">{selected.size} selected</span>
          <div className="flex-1" />
          <button onClick={() => bulkAction("feature")} className="flex items-center gap-1.5 px-3 py-1.5 font-mono text-[11px] uppercase tracking-widest text-[#EDEDED] border border-white/[0.12] rounded-sm hover:bg-white/[0.04] transition-colors">
          ...
          <button onClick={() => bulkAction("activate")} className="flex items-center gap-1.5 px-3 py-1.5 font-mono text-[11px] uppercase tracking-widest text-[#EDEDED] border border-white/[0.12] rounded-sm hover:bg-white/[0.04] transition-colors">
              ...
              >
                ...
                <td className="px-4 py-3">
                  <Link
                    ...
                    className="font-mohave text-[13px] text-[#EDEDED] hover:text-[#6F94B0] transition-colors"
                  >
                    {p.name}
                  </Link>
                </td>
                ...
                <td className="px-4 py-3">
                  {p.archivedAt ? (
                    ...
                    <span className="px-2 py-0.5 bg-ops-accent/20 rounded-sm font-mono text-micro uppercase tracking-widest text-[#6F94B0]">
                      Active
                    </span>
                  )}
                </td>
