    ...
    >
      ...
      <AnimatePresence>
        {!focusedNode && !allQuestionsAnswered && (
          ...
          >
            <p className="font-mono text-[11px] text-text-3 uppercase tracking-[0.2em] max-w-[400px] leading-relaxed">
      ...
      >
        ...
        <p className="font-mono text-micro text-text-mute text-center mt-2">
