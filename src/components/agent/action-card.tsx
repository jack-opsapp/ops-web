...
export const ActionCard = memo(function ActionCard({
  ...
  return (
    <motion.div
      ...
      {...motionProps}
      className={cn(
        "rounded-[8px] border border-l-[3px] transition-colors duration-150",
      ...
      <div className="flex items-start gap-3 p-4">
        ...
        {isPending && (
          ...
          >
            ...
            >
              {selected && <Check className="w-[14px] h-[14px] text-white mx-auto mt-[2px]" />}
            </div>
          </button>
        )}

        {/* Type icon */}
        <div className="shrink-0 w-[32px] h-[32px] rounded-[4px] bg-[rgba(255,255,255,0.04)] flex items-center justify-center mt-3">
        ...
        <div className="flex-1 min-w-0 pt-2">
          <div className="flex items-center gap-2">
            <span className="font-mohave text-body-sm text-text-primary uppercase truncate">
          ...
          <p className="font-kosugi text-[13px] text-text-secondary mt-0.5 line-clamp-2">
            {(() => {
            ...
            <div className="flex items-center gap-4 mt-2 flex-wrap">
              {taskData.project_name && (
                <div className="flex items-center gap-1">
                  <FolderKanban className="w-[12px] h-[12px] text-text-tertiary" />
                  <span className="font-kosugi text-[11px] text-text-secondary truncate max-w-[140px]">
                    {taskData.project_name}
                  </span>
                </div>
              )}
              <div className="flex items-center gap-1">
                <User className="w-[12px] h-[12px] text-text-tertiary" />
                <span className="font-kosugi text-[11px] text-text-secondary">
                  {selectedMemberName ?? t("task.unassigned")}
                </span>
              </div>
              <div className="flex items-center gap-1">
                <CalendarDays className="w-[12px] h-[12px] text-text-tertiary" />
                <span className="font-kosugi text-[11px] text-text-secondary">
                  {formatDateRange(
          ...
          {isReassign && reassignData && (
            <div className="flex items-center gap-3 mt-2 flex-wrap">
              ...
              <div className="flex items-center gap-1">
                ...
                <ArrowRight className="w-[10px] h-[10px] text-text-tertiary" />
                <span className="font-kosugi text-[11px] text-text-secondary">
          ...
          {isArchive && archiveData && (
            <div className="flex items-center gap-4 mt-2 flex-wrap">
              <div className="flex items-center gap-1">
                <FolderKanban className="w-[12px] h-[12px] text-text-tertiary" />
                <span className="font-kosugi text-[11px] text-text-secondary truncate max-w-[160px]">
          ...
          {isInvoiceEmail && invoiceEmailData && (
            <div className="flex items-center gap-4 mt-2 flex-wrap">
              <div className="flex items-center gap-1">
                <Mail className="w-[12px] h-[12px] text-text-tertiary" />
                <span className="font-kosugi text-[11px] text-text-secondary truncate max-w-[180px]">
              ...
              {invoiceEmailData.attachments.length > 0 && (
                <div className="flex items-center gap-1">
                  <Paperclip className="w-[12px] h-[12px] text-text-tertiary" />
                </div>
              )}
            </div>
          )}
          ...
          {isOptimizeSchedule && optimizeData && (
            <div className="flex items-center gap-4 mt-2 flex-wrap">
              ...
              <div className="flex items-center gap-1">
                <Route className="w-[12px] h-[12px] text-text-tertiary" />
            ...
            <div className="flex items-center gap-4 mt-2 flex-wrap">
              {rescheduleData.resolution_type === "conflict" && rescheduleData.conflict_details && (
                <>
                  ...
                  <span className="font-kosugi text-[11px] text-text-secondary truncate max-w-[200px]">
              ...
              {rescheduleData.resolution_type === "assign" && (
                <>
                  <div className="flex items-center gap-1">
                    <MapPin className="w-[12px] h-[12px] text-text-tertiary" />
                    <span className="font-kosugi text-[11px] text-text-secondary truncate max-w-[160px]">
          ...
          {isAppointmentConfirm && appointmentData && (
            <div className="flex items-center gap-4 mt-2 flex-wrap">
              ...
              {appointmentData.crew_names.length > 0 && (
                <div className="flex items-center gap-1">
                  <Users className="w-[12px] h-[12px] text-text-tertiary" />
                  <span className="font-kosugi text-[11px] text-text-secondary truncate max-w-[160px]">
          ...
          {isDayBeforeReminder && dayBeforeData && (
            <div className="flex items-center gap-4 mt-2 flex-wrap">
              ...
              <div className="flex items-center gap-1">
                <BellPlus className="w-[12px] h-[12px] text-[#597794]" />
                <span className="font-kosugi text-[11px] text-[#597794] uppercase">
          ...
          {isRescheduleRequest && rescheduleRequestData && (
            <div className="flex items-center gap-4 mt-2 flex-wrap">
              ...
              <div className="flex items-center gap-1">
                <CalendarDays className="w-[12px] h-[12px] text-text-tertiary" />
                <span className="font-mono text-[11px] text-text-tertiary line-through">
                  {formatDateTime(
                ...
                <ArrowRight className="w-[10px] h-[10px] text-text-tertiary" />
                <span className="font-mono text-[11px] text-[#597794]">
          ...
          {isSubcontractorCoord && subcontractorData && (
            <div className="flex items-center gap-4 mt-2 flex-wrap">
              <div className="flex items-center gap-1">
                <HardHat className="w-[12px] h-[12px] text-text-tertiary" />
                <span className="font-kosugi text-[11px] text-text-secondary truncate max-w-[160px]">
          ...
          <div className="flex items-center gap-3 mt-2 flex-wrap">
            ...
            {sourceUrl && (
              <a
                href={sourceUrl}
                className="flex items-center gap-1 font-kosugi text-[11px] text-text-tertiary hover:text-text-secondary transition-colors min-h-[56px] px-1 -my-4"
              >
        ...
        <div className="shrink-0 flex flex-col items-end gap-2 pt-1">
          ...
          >
            {expanded ? (
              <ChevronUp className="w-[16px] h-[16px] text-text-tertiary" />
            ) : (
          ...
          {isPending && (
            <div className="flex items-center gap-1">
              <button
                ...
                className="min-h-[56px] px-4 rounded-[4px] bg-[rgba(89,119,148,0.15)] text-[#597794] font-mohave text-body-sm uppercase hover:bg-[rgba(89,119,148,0.25)] transition-colors"
              >
          ...
          {!isPending && (
            <span
              className={cn(
                ...
                action.status === "expired" && "bg-[rgba(255,255,255,0.04)] text-text-tertiary",
                action.status === "cancelled" && "bg-[rgba(255,255,255,0.04)] text-text-tertiary",
                action.status === "approved" && "bg-[rgba(89,119,148,0.15)] text-[#597794]"
              )}
            >
              ...
              <div className="pt-3 space-y-3">
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-1.5">
                        ...
                        {!editingAssignment && teamMembers && teamMembers.length > 0 && (
                          <button
                            ...
                            className="font-kosugi text-[11px] text-text-secondary hover:text-text-primary transition-colors min-h-[56px] min-w-[56px] flex items-center justify-center -my-4"
                          >
                      ...
                      {editingAssignment && teamMembers ? (
                        /* Fix 6 + Fix 33: 56dp items, rounded-[4px] */
                        <div className="space-y-1 max-h-[200px] overflow-y-auto scrollbar-hide rounded-[4px] border border-[rgba(255,255,255,0.06)] bg-[rgba(255,255,255,0.02)] p-1">
                            ...
                            <button
                              ...
                              className={cn(
                                ...
                                member.id === selectedMemberId
                                  ...
                                  : "hover:bg-[rgba(255,255,255,0.03)] text-text-primary"
                              )}
                            >
                              <div className="min-w-0">
                                ...
                                <span className="font-kosugi text-[10px] text-text-tertiary block">
                              ...
                              {member.id === selectedMemberId && (
                                <Check className="w-[14px] h-[14px] text-[#597794] shrink-0" />
                              )}
                              {member.hasConflicts && member.id !== selectedMemberId && (
                                <span className="font-kosugi text-[10px] text-[#C4A868] shrink-0">
                                  {t("task.busy")}
                                </span>
                              )}
                            </button>
                          ...
                          {teamMembers.length === 0 && (
                            <p className="px-2.5 py-2 font-kosugi text-[11px] text-text-disabled">
                              {t("task.noMembers")}
                            </p>
                          )}
                        </div>
                    ...
                    {taskData.assignment_reason && (
                      <div>
                        ...
                        <p className="font-kosugi text-[12px] text-text-secondary mt-0.5">
                          {taskData.assignment_reason}
                        </p>
                      </div>
                    )}
                    ...
                    <div>
                      ...
                      {editingDates ? (
                        <div className="flex items-center gap-2 flex-wrap">
                          <div>
                            <label className="font-kosugi text-[10px] text-text-tertiary block mb-0.5">
                              {t("task.startDate")}
                            </label>
                            ...
                            <input
                              ...
                              className="font-mohave text-body-sm bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.08)] rounded-[4px] px-2.5 py-1.5 text-text-primary outline-none focus:border-[rgba(255,255,255,0.3)] min-h-[56px] [color-scheme:dark]"
                            />
                          </div>
                          <div>
                            <label className="font-kosugi text-[10px] text-text-tertiary block mb-0.5">
                          ...
                          <button
                            ...
                            className="font-kosugi text-[11px] text-text-secondary hover:text-text-primary transition-colors min-h-[56px] min-w-[56px] flex items-center justify-center mt-4"
                          >
                            {t("action.collapse")}
                          </button>
                        </div>
                        ...
                        <div className="flex items-center gap-2">
                          <CalendarDays className="w-[14px] h-[14px] text-text-tertiary" />
                          <span className="font-mohave text-body-sm text-text-primary">
                            {formatDateRange(
                              editStartDate ? new Date(editStartDate).toISOString() : null,
                              editEndDate ? new Date(editEndDate).toISOString() : null,
                    ...
                    <div>
                      ...
                      {editingDraft ? (
                        <textarea
                          ...
                          rows={8}
                          className="w-full font-kosugi text-[12px] bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.08)] rounded-[4px] px-3 py-2.5 text-text-primary outline-none focus:border-[rgba(255,255,255,0.3)] resize-y min-h-[120px] [color-scheme:dark]"
                        />
                      ) : (
                        <p className="font-kosugi text-[12px] text-text-secondary mt-0.5 whitespace-pre-wrap line-clamp-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <div className="rounded-[4px] border border-[rgba(255,255,255,0.06)] overflow-hidden">
                        ...
                        <div className="grid grid-cols-[1fr_60px_80px_80px] gap-2 px-3 py-1.5 bg-[rgba(255,255,255,0.02)] border-b border-[rgba(255,255,255,0.06)]">
                          <span className="font-kosugi text-[10px] text-text-tertiary uppercase">{t("invoice.item")}</span>
                          <span className="font-kosugi text-[10px] text-text-tertiary uppercase text-right">{t("invoice.qty")}</span>
                          <span className="font-kosugi text-[10px] text-text-tertiary uppercase text-right">{t("invoice.unitPrice")}</span>
                          <span className="font-kosugi text-[10px] text-text-tertiary uppercase text-right">{t("invoice.lineTotal")}</span>
                        </div>
                              ...
                              {editingLineItems ? (
                                <>
                                  <input
                                    ...
                                    className="font-kosugi text-[12px] bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.08)] rounded-[4px] px-2 py-1 text-text-primary outline-none focus:border-[rgba(255,255,255,0.3)] min-h-[56px]"
                                  />
                                  <input
                                    type="number"
                                    value={item.quantity}
                                    ...
                                    className="font-mono text-[12px] bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.08)] rounded-[4px] px-2 py-1 text-text-primary outline-none focus:border-[rgba(255,255,255,0.3)] text-right min-h-[56px] [color-scheme:dark]"
                                    min={0}
                                    step="any"
                                  />
                                  <input
                                  ...
                                  <div className="flex items-center justify-end gap-1">
                                    ...
                                    <button
                                      ...
                                      className="min-w-[56px] min-h-[56px] flex items-center justify-center text-text-tertiary hover:text-[#93321A] transition-colors"
                                    >
                                ...
                                <>
                                  <span className="font-kosugi text-[12px] text-text-primary truncate">
                                    {item.name}
                                  </span>
                        ...
                        {editingLineItems && (
                          <button
                            ...
                            className="w-full flex items-center justify-center gap-1 px-3 py-2 border-t border-[rgba(255,255,255,0.06)] text-text-tertiary hover:text-text-secondary transition-colors min-h-[56px]"
                          >
                    ...
                    <div className="flex justify-end">
                      <div className="w-[240px] space-y-1">
                        <div className="flex justify-between">
                          <span className="font-kosugi text-[11px] text-text-tertiary">{t("invoice.subtotal")}</span>
                          <span className="font-mono text-[12px] text-text-secondary">
                        ...
                        {discountAmt > 0 && (
                          <div className="flex justify-between">
                            <span className="font-kosugi text-[11px] text-text-tertiary">{t("invoice.discount")}</span>
                            <span className="font-mono text-[12px] text-text-secondary">
                        ...
                        <div className="flex justify-between border-t border-[rgba(255,255,255,0.08)] pt-1">
                          <span className="font-mohave text-body-sm text-text-primary uppercase">{t("invoice.total")}</span>
                    ...
                    {invoiceData.cover_email && invoiceData.cover_email.to && (
                      <div className="flex items-center gap-2 px-3 py-2 rounded-[4px] bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.06)]">
                        <Mail className="w-[14px] h-[14px] text-text-tertiary" />
                        <span className="font-kosugi text-[12px] text-text-secondary">
                ...
                {isInvoiceEmail && invoiceEmailData && isPending && (
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <span className="font-kosugi text-[12px] text-text-secondary mt-0.5 block">
                    ...
                    {invoiceEmailData.attachments.length > 0 && (
                      <div className="flex items-center gap-2 px-3 py-2 rounded-[4px] bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.06)]">
                        <Paperclip className="w-[14px] h-[14px] text-text-tertiary" />
                        <span className="font-kosugi text-[12px] text-text-secondary">
                ...
                {isPaymentReminder && reminderData && isPending && (
                  <div className="space-y-3">
                    ...
                    <div>
                      <span className="font-kosugi text-[11px] text-text-tertiary uppercase block mb-1.5">
                        [{t("reminder.level")}]
                      </span>
                      <div className="flex items-center gap-1">
                        {[1, 2, 3, 4].map((level) => (
                ...
                */}
                  ...
                  <div className="space-y-3">
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div>
                          ...
                          {optimizeData.current_order.map((stop, idx) => (
                            <div key={stop.task_id} className="flex items-start gap-2">
                              ...
                              <div className="min-w-0 pt-[2px]">
                                <span className="font-mohave text-[12px] text-text-secondary block truncate">
                                  {stop.task_title}
                                </span>
                                {stop.address && (
                                  <span className="font-kosugi text-[10px] text-text-tertiary block truncate">
                                    {stop.address}
                                  </span>
                                )}
                              </div>
                        ...
                        <span className="font-kosugi text-[10px] text-text-tertiary mt-2 block">
                      ...
                      <div>
                            ...
                            <div key={stop.task_id} className="flex items-start gap-2">
                              <div className="flex flex-col items-center">
                                <div className="w-[20px] h-[20px] rounded-full border border-[rgba(255,255,255,0.24)] flex items-center justify-center shrink-0">
                                  <span className="font-mono text-[10px] text-text-primary">{idx + 1}</span>
                                </div>
                              ...
                              <div className="min-w-0 pt-[2px]">
                                <span className="font-mohave text-[12px] text-text-primary block truncate">
                                  {stop.task_title}
                                </span>
                                {stop.address && (
                                  <span className="font-kosugi text-[10px] text-text-tertiary block truncate">
                        ...
                        <span className="font-kosugi text-[10px] text-text-secondary mt-2 block">
                ...
                {isRescheduleTasks && rescheduleData && (
                  <div className="space-y-3">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="space-y-1">
                          {rescheduleData.conflict_details.map((task) => (
                            <div
                              key={task.task_id}
                              className="flex items-center gap-2 px-2 py-1.5 rounded-[4px] border border-[rgba(255,255,255,0.06)] bg-[rgba(255,255,255,0.02)]"
                            >
                              <div
                              ...
                              <div className="min-w-0 flex-1">
                                ...
                                <span className="font-kosugi text-[10px] text-text-tertiary">
                        ...
                        {rescheduleData.suggested_resolution && (
                          <div className="mt-2 px-2 py-2 rounded-[4px] border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.02)]">
                            <span className="font-kosugi text-[10px] text-text-tertiary block mb-1">
                    ...
                    {rescheduleData.resolution_type === "assign" && (
                      <div className="space-y-2">
                        <div>
                          <span className="font-kosugi text-[11px] text-text-tertiary">[{tSched("unassigned.task")}]</span>
                          <p className="font-mohave text-[13px] text-text-primary mt-0.5">
                            {rescheduleData.task_title}
                          </p>
                        ...
                        {rescheduleData.assignment_reason && (
                          <div>
                            <span className="font-kosugi text-[11px] text-text-tertiary">[{tSched("unassigned.reason")}]</span>
                            <p className="font-kosugi text-[12px] text-text-secondary mt-0.5">
                              {rescheduleData.assignment_reason}
                            </p>
                          </div>
                    ...
                    {rescheduleData.resolution_type === "cascade" && (
                      <div className="space-y-2">
                        <div>
                          <span className="font-kosugi text-[11px] text-text-tertiary">[{tSched("cascade.trigger")}]</span>
                          <p className="font-kosugi text-[12px] text-text-secondary mt-0.5">
                        ...
                        {rescheduleData.affected_tasks && rescheduleData.affected_tasks.length > 0 && (
                          <div>
                            <span className="font-kosugi text-[11px] text-text-tertiary">[{tSched("cascade.affectedTasks")}]</span>
                            <div className="space-y-1 mt-1">
                              {rescheduleData.affected_tasks.map((task) => (
                                <div
                                  key={task.task_id}
                                  className="flex items-center justify-between px-2 py-1.5 rounded-[4px] border border-[rgba(255,255,255,0.06)] bg-[rgba(255,255,255,0.02)]"
                                >
                                  <div className="min-w-0">
                                    <span className="font-mohave text-[12px] text-text-primary block truncate">
                                      {task.task_title}
                                  ...
                                  <div className="text-right shrink-0">
                                    ...
                                    {task.proposed_start_date && (
                                      <span className="font-kosugi text-[10px] text-text-secondary block">
                  ...
                  <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                          {appointmentData.crew_names.map((name) => (
                            <div
                              key={name}
                              className="flex items-center gap-1 px-2 py-1 rounded-[4px] bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.06)]"
                            >
                              <User className="w-[12px] h-[12px] text-text-tertiary" />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full font-mohave text-body-sm bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.08)] rounded-[4px] px-3 py-2 text-text-primary outline-none focus:border-[rgba(255,255,255,0.3)] min-h-[56px]"
                      />
                    </div>
                ...
                {isDayBeforeReminder && dayBeforeData && isPending && (
                  <div
                    className={cn(
                      ...
                      dayBeforeData.weather_risk &&
                        dayBeforeData.weather_risk.risk_level !== "low" &&
                        "px-3 py-3 rounded-[4px] border border-[rgba(196,168,104,0.25)] bg-[rgba(196,168,104,0.04)]"
                    )}
                  >
                    {/* TOMORROW badge */}
                    <div className="flex items-center gap-2">
                      <BellPlus className="w-[14px] h-[14px] text-[#597794]" />
                      <span className="font-mohave text-[14px] text-[#597794] uppercase tracking-wider">
                ...
                {isRescheduleRequest && rescheduleRequestData && isPending && (
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <blockquote className="font-kosugi text-[12px] text-text-secondary italic pl-3 border-l-[2px] border-l-[rgba(255,255,255,0.12)] whitespace-pre-wrap line-clamp-6">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 flex-wrap">
                        <span className="font-mohave text-[13px] text-text-primary">
                          {rescheduleRequestData.task_title}
                        </span>
                        <span className="font-mono text-[11px] text-text-tertiary line-through">
                          {formatDateTime(
                        ...
                        <ArrowRight className="w-[12px] h-[12px] text-text-tertiary" />
                        <span className="font-mono text-[11px] text-[#597794]">
                          {rescheduleRequestData.requested_date
                            ? formatDateTime(
                                rescheduleRequestData.requested_date,
                      ...
                      {rescheduleRequestData.requested_reason && (
                        <p className="font-kosugi text-[11px] text-text-tertiary mt-1">
                            ...
                            return (
                              <button
                                ...
                                className={cn(
                                  ...
                                  isSelected
                                    ? "bg-[rgba(89,119,148,0.12)] border border-[rgba(89,119,148,0.5)]"
                              ...
                              >
                                ...
                                <div className="min-w-0 flex-1">
                                  ...
                                  {alt.team_member_name && (
                                    <span className="font-kosugi text-[11px] text-text-tertiary mt-0.5 block">
                                      {alt.team_member_name}
                                    </span>
                                  )}
                                  <span className="font-kosugi text-[10px] text-text-tertiary mt-0.5 block">
                                    {interpolate(
                    ...
                    <div className="flex items-center gap-1">
                      <Gauge className="w-[12px] h-[12px] text-text-tertiary" />
                      <span className="font-kosugi text-[11px] text-text-tertiary">
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      {subcontractorData.project_address && (
                        <span className="font-kosugi text-[11px] text-text-tertiary block mt-0.5">
                          {subcontractorData.project_address}
                        </span>
                      )}
                    </div>
                ...
                {!isTaskAction && !isStatusEmail && !isReassign && !isArchive && !isCreateInvoice && !isInvoiceEmail && !isPaymentReminder && !isHealthAlert && !isFinancialInsight && !isOptimizeSchedule && !isRescheduleTasks && !isAppointmentConfirm && !isDayBeforeReminder && !isRescheduleRequest && !isSubcontractorCoord && !isPending && (
                  <div>
                    ...
                    <pre className="mt-1 p-2 rounded-[4px] bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.06)] font-mono text-[12px] text-text-secondary overflow-x-auto max-h-[200px] overflow-y-auto scrollbar-hide">
