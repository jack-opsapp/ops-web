...
export function ChannelDivider({ channel, subject }: ChannelDividerProps) {
  ...
  return (
    <div className="flex items-center gap-1.5 my-1.5">
      ...
      <span
        className={cn(
          "font-kosugi text-micro-sm uppercase tracking-[0.5px] shrink-0",
...
export function DateDivider({ label }: DateDividerProps) {
  return (
    <div className="flex items-center gap-2 my-2">
      <div className="flex-1 h-px bg-[rgba(255,255,255,0.04)]" />
      <span className="font-kosugi text-micro-sm uppercase tracking-[0.3px] text-[rgba(255,255,255,0.15)]">
        {label}
      </span>
      <div className="flex-1 h-px bg-[rgba(255,255,255,0.04)]" />
    </div>
