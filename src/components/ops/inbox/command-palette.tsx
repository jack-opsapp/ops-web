  ...
  return (
    <CommandDialog open={open} onOpenChange={onOpenChange}>
      <CommandInput
        ...
        placeholder="Search threads · run a command"
        onClear={query ? () => setQuery("") : undefined}
      />

      <CommandList>
        <CommandEmpty>
          {searchLoading ? "Searching…" : "Nothing matches that."}
        </CommandEmpty>
        ...
        {selectedThreadId && (
          <>
            <CommandGroup heading="This thread">
              ...
              >
                <Archive className="w-[14px] h-[14px] text-text-3" />
                Archive thread
              ...
              >
                <Tag className="w-[14px] h-[14px] text-text-3" />
                Recategorize thread
                <span className="ml-auto">
                  <KeyHint keys="L" />
                </span>
              ...
              >
                <Sparkles className="w-[14px] h-[14px] text-text-3" />
        ...
        <CommandGroup heading="Navigate">
          ...
          >
            <Inbox className="w-[14px] h-[14px] text-text-3" />
            Go to Needs Reply
            <span className="ml-auto">
              <KeyHint keys="1" />
            </span>
          ...
          >
            <CheckCircle2 className="w-[14px] h-[14px] text-text-3" />
            Go to Done
            <span className="ml-auto">
              <KeyHint keys="4" />
            </span>
          </CommandItem>
          <CommandItem value="all categories" onSelect={() => run(() => handlers.onFilterCategory(null))}>
            <Hash className="w-[14px] h-[14px] text-text-3" />
        ...
        {/* Category filters */}
        <CommandGroup heading="Filter category">
        ...
        <CommandGroup heading="Create">
          ...
          >
            <Plus className="w-[14px] h-[14px] text-text-3" />
            Compose new email
            <span className="ml-auto">
              <KeyHint keys="C" />
            </span>
