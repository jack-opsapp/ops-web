          ...
          {isFull ? (
            <div className="flex items-center gap-3 mt-2">
              <button
                ...
                className="font-mono text-micro uppercase tracking-wider text-text-2 hover:text-text transition-colors"
              >
                Manage seats
              </button>
              <Link
                href="/settings?tab=subscription"
                className="font-mono text-micro uppercase tracking-wider text-text-2 hover:text-text transition-colors inline-flex items-center gap-1"
              >
                Upgrade plan
            ...
            <button
              ...
              className="mt-2 bg-status-warning/20 hover:bg-status-warning/30 text-status-warning border border-status-warning/40 font-mono text-micro uppercase tracking-wider rounded-sm px-3 py-2 transition-colors disabled:opacity-50"
            >
