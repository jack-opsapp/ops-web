...
export function SignOutOverlay() {
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-background flex flex-col items-center justify-center">
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-1.5">
                <span className="font-mono text-micro text-text-mute uppercase tracking-[0.15em]">
                  {line.label}
                </span>
                <span
                  className="font-mono text-micro uppercase tracking-[0.1em] transition-colors duration-200"
      ...
      {/* Timestamp */}
      <p className="font-mono text-micro text-[rgba(255,255,255,0.08)] uppercase tracking-[0.2em] mt-10 select-none">
