      ...
      <div className="flex-1 min-w-0">
        <div className={cn(
          ...
          comment.isClientVisible
            ? "bg-[#1A2A1A] text-[#EDEDED]"
            : "bg-glass glass-surface text-[#EDEDED]"
        )}>
          {comment.content}
        </div>
    ...
    <div className={cn(
      ...
      <div className="flex-1 relative">
        <textarea
          ...
          rows={1}
          className="w-full bg-surface-input border border-[#2A2A2A] rounded-xl px-3 py-2 text-sm text-[#EDEDED] placeholder-[#555] resize-none outline-none focus:border-[#417394]/50 transition-colors"
        />
