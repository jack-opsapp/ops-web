              ...
              value={
                data.company ? (
                  <Link
                    ...
                    className="text-text transition-colors duration-150 ease-smooth hover:text-text-2"
                  >
          ...
          <form action={updateEta} className="flex flex-wrap items-center gap-3">
            ...
            <label className="flex flex-col gap-1.5">
              ...
              <input
                ...
                className="rounded border border-white/[0.10] bg-black px-3 py-1.5 font-mono text-[12px] tabular-nums text-text outline-none transition-colors duration-150 ease-smooth focus:border-ops-accent"
              />
            </label>
            <button
              type="submit"
              className="rounded border border-ops-accent px-3 py-1.5 font-mono text-[11px] uppercase tracking-[0.16em] text-ops-accent transition-colors duration-150 ease-smooth hover:bg-ops-accent hover:text-black"
            >
              UPDATE ETA
            </button>
...
function Panel({
  ...
  return (
    <section
      aria-label={title}
      className={`rounded-panel border ${borderClass} bg-glass p-5 backdrop-blur-[28px]`}
    >
