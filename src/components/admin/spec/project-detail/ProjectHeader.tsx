  ...
  return (
    <header className="border-b border-white/[0.08] px-8 py-6">
      <div className="mb-3">
        <Link
          href="/admin/spec"
          className="font-mono text-[11px] uppercase tracking-[0.18em] text-text-mute transition-colors duration-150 ease-[cubic-bezier(0.22,1,0.36,1)] hover:text-text-3"
        >
