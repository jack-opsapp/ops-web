      ...
      {changeType === "minor_hourly" && (
        <FieldRow label="ESTIMATED HOURS">
          <input
            ...
            required
            placeholder="0.5 – 3.5"
            className="w-32 rounded border border-white/[0.10] bg-black px-3 py-2 font-mono text-[12px] tabular-nums text-text outline-none transition-colors duration-150 ease-smooth focus:border-ops-accent"
          />
        ...
        <FieldRow label="FIXED PRICE">
          <span className="inline-flex items-center gap-2">
            ...
            <input
              ...
              className="w-48 rounded border border-white/[0.10] bg-black px-3 py-2 font-mono text-[12px] tabular-nums text-text outline-none transition-colors duration-150 ease-smooth focus:border-ops-accent"
            />
          </span>
        </FieldRow>
      )}
      ...
      <FieldRow label="DELIVERY IMPACT">
        <span className="inline-flex items-center gap-2">
          <input
            ...
            step={1}
            defaultValue={0}
            className="w-24 rounded border border-white/[0.10] bg-black px-3 py-2 font-mono text-[12px] tabular-nums text-text outline-none transition-colors duration-150 ease-smooth focus:border-ops-accent"
          />
...
function RadioPill({
  ...
  return (
    <button
      ...
      className={`flex min-w-[140px] flex-col items-start gap-0.5 rounded border px-3 py-2 text-left transition-colors duration-150 ease-smooth ${
        active
