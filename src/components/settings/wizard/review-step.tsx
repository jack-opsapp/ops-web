...
export function ReviewStep({
  ...
  const totalTemplates = enabledTypes.reduce((sum, tt) => sum + tt.templateCount, 0);
    ...
    >
      ...
      <p className="font-mohave text-body text-text-secondary mb-[4px]">
        {t("wizard.review.summary")
          .replace("{count}", String(enabledTypes.length))
      ...
      {/* Task type list */}
      <div className="space-y-[6px] mb-[24px] max-h-[280px] overflow-y-auto scrollbar-hide">
        {enabledTypes.map((tt) => (
          <div
            key={tt.name}
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          disabled={status === "creating" || enabledTypes.length === 0}
