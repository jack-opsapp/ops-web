...
const STAGE_CONFIG: Record<string, { label: string; color: string }> = {
  ...
  qualifying: { label: "Qualifying", color: "#B5A381" },
  quoting: { label: "Quoting", color: "#8195B5" },
  quoted: { label: "Quoted", color: "#9DB582" },
  follow_up: { label: "Follow Up", color: "#C4A868" },
...
export function ReviewImportStep({
  ...
  return (
    <div>
      ...
      {/* Import button */}
      <div className="mt-6 flex items-center justify-between pt-4 border-t border-white/8">
