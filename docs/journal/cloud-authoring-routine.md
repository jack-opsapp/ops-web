...
- image_prompt: 120–1,500 characters of plain sentences directing the header photograph, following the brief's header photograph rules. OPS adds the house style (photorealistic, 16:9, no text or logos, safe work) after it, so describe the moment, not the style.
...
CANDIDATE SHAPE (JSON, exactly these keys)
{
  ...
  "image_prompt": "120-1500 chars: the one physical moment the photograph shows",
  "body": [
