...
- image_prompt: 120–1,500 characters of plain sentences directing the header photograph, following the brief's header photograph rules: composed, never posed; candid, never staged; nobody smiling at or looking into the camera. It may show an adjacent subject rather than the obvious one. Describe the scene, the moment, the composition (negative space, natural framing, leading lines, layers, the third that holds the subject), the vantage and the light; ask for black and white only now and then. OPS adds the house style after it (candid editorial documentary, subdued grade, 16:9-safe, no text or logos, safe work).
