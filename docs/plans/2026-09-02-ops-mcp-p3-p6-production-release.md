# OPS MCP Phases 3–7 Production Release Plan
...
- Phase 7 Web commit: `e58894f90048d66dda1c4f4e7e2edc90c286e599`
- Phase 7 Bible commit: `3d80d64ad00a51f6467241d2a3e6b369090bf839`
...
5. Confirm the release diff contains Phases 3–7 and excludes Phase 8.
...
6. Re-read database state to prove the deployed code did not activate v5–v9.

### Task 6: Publish the authoritative Bible record

1. Add the production migration ledger names, Web commit, deployment ID, and dormant-state proof to the Phase 3–7 Bible specifications and canonical chapters.
...
3. Verify live migration ledger, RPC ACLs, active v2 state, and dormant v5–v9 state.
