...
- Create: `supabase/migrations/20260725030000_external_api_authorization_foundation.sql`
...
```bash
git add supabase/migrations/20260725030000_external_api_authorization_foundation.sql scripts/run-external-api-sql-contracts.mjs package.json src/lib/types/database.types.ts tests/unit/supabase/external-api-authorization-migration.test.ts tests/sql/external-api-authorization-contract.sql
...
- Create: `supabase/migrations/20260725031000_external_intake_upload_foundation.sql`
...
```bash
git add supabase/migrations/20260725031000_external_intake_upload_foundation.sql src/lib/external-api/uploads src/app/v1/intake/uploads src/lib/types/database.types.ts tests
...
- Create: `supabase/migrations/20260725032000_external_intake_attachment_processing.sql`
...
```bash
git add supabase/migrations/20260725032000_external_intake_attachment_processing.sql src/lib/external-api/uploads src/app/api/cron/external-api-maintenance vercel.json src/lib/types/database.types.ts tests
...
- Create: `supabase/migrations/20260725033000_external_lead_intake_command.sql`
...
```bash
git add supabase/migrations/20260725033000_external_lead_intake_command.sql src/lib/external-api/intake/submission-service.ts src/lib/types/database.types.ts src/lib/api/services/unassigned-lead-assignment-delivery-service.ts tests
...
- Create: `supabase/migrations/20260725034000_external_intake_lead_file_access.sql`
...
```bash
git add supabase/migrations/20260725034000_external_intake_lead_file_access.sql src/lib/api/services/opportunity-assigned-context-service.ts src/lib/api/services/project-file-service.ts src/lib/external-api/uploads src/app/api/opportunities src/app/'(dashboard)'/pipeline/_components src/i18n/dictionaries src/lib/types/database.types.ts tests
...
- Create: `supabase/migrations/20260725035000_external_analytics_lifecycle_evidence.sql`
...
```bash
git add supabase/migrations/20260725035000_external_analytics_lifecycle_evidence.sql src/lib/api/services src/lib/email src/lib/types/database.types.ts tests
...
- Create: `supabase/migrations/20260725036000_external_lead_projection.sql`
...
```bash
git add supabase/migrations/20260725036000_external_lead_projection.sql src/lib/external-api/analytics scripts/backfill-external-lead-projections.mjs package.json src/lib/types/database.types.ts tests
...
- Create: `supabase/migrations/20260725037000_external_lead_metrics_v1.sql`
...
```bash
git add supabase/migrations/20260725037000_external_lead_metrics_v1.sql src/lib/external-api/analytics src/app/v1/analytics/metrics src/lib/types/database.types.ts tests
