...
**Architecture:** Extend the Phase15 private policy ledger with owner-bound preview/enrollment/revocation and readiness. Reuse the financial source, authority, exact OPS approval and durable receipt contracts. Candidate consent/exposure stays dormant; no business seeds or effect-fingerprint renewal.
...
- Add immutable candidate v12 consent with exact preparation-only description and candidate validation; keep public active v14/v9 and selectable exposure unchanged. Document exact remaining activation patch/binding gates.
