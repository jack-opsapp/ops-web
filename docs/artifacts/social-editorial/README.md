...
Production release and preparation activation are recorded separately in `production-release-2026-09-05.md`. They do not change the local-only provenance of these canary images.
