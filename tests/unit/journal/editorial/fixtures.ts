...
export function validPitch(overrides: Record<string, unknown> = {}) {
  return {
    ...
    hooks_considered: [
      ["YOUR NEW GUY QUIT BEFORE LUNCH", 3, "Chosen: plain, a moment every owner has lived, and all three readers would click."],
      ...[
        "WHY NEW HIRES QUIT IN THE FIRST WEEK",
        "HOW TO KEEP A NEW HELPER PAST DAY ONE",
        "THE FIRST WEEK DECIDES WHO STAYS",
        "STOP LOSING HELPERS IN THEIR FIRST MONTH",
        "WHY YOUR BEST HIRE WALKS BY FRIDAY",
        "WHAT GOOD HELPERS NEED ON DAY ONE",
        "HOW TO RUN A NEW HIRE'S FIRST WEEK",
        "NEW HIRES QUIT BOSSES, NOT WORK",
        "THE 90 DAYS THAT KEEP A GOOD HAND",
        "WHY GOOD HELPERS NEVER COME BACK",
        "HOW TO ONBOARD A HELPER WITHOUT AN OFFICE",
        "YOUR HIRING PROBLEM IS A FIRST-WEEK PROBLEM",
        "WHAT TO SAY TO A NEW HIRE AT 6 A.M.",
        "KEEP THE HELPER YOU JUST HIRED",
        "THE REAL REASON HELPERS QUIT",
        "HIRE ONCE, NOT FOUR TIMES A YEAR",
        "HOW SMALL CREWS KEEP NEW HIRES",
        "DAY ONE ON A CREW, DONE RIGHT",
        "WHY HELPERS GHOST AFTER A WEEK",
        "A FIRST-WEEK PLAN FOR NEW HELPERS",
        "STOP TRAINING HELPERS WHO LEAVE",
        "WHAT NEW HIRES NOTICE ON THEIR FIRST DAY",
        "THE COST OF A HELPER WHO QUITS",
        "HOW TO MAKE A NEW HIRE WANT TO STAY",
      ].map((headline) => [headline, 0, "Plain, but no reader picked it."] as const),
    ].map(([headline, clicks, verdict]) => ({ headline, hook: "A new hire leaves on day one.", verdict, clicks })),
    runners_up: [
