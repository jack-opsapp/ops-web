...
-- Compose exact OAuth tables, constraints and triggers with the financial fixture.
-- Captured schema contains no live rows. Existing financial tables remain intact.
...
-- Refresh definitions from the read-only September 8 baseline before guarded migration.
